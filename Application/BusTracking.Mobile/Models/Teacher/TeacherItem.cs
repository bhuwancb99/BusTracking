namespace BusTracking.Mobile.Models.Teacher
{
    public class TeacherItem
    {
        ...
        public string DepartmentDisplay => !string.IsNullOrWhiteSpace(Department) ? Department : "General";
        public string DesignationDisplay => !string.IsNullOrWhiteSpace(Designation) ? Designation : "Teacher";
    }
}
