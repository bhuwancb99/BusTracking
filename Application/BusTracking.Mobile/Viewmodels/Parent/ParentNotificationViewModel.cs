...
{
    public partial class ParentNotificationViewModel : BaseViewModel
    {
        ...
        public ParentNotificationViewModel(IAuthService auth, INavigationService nav, IApiService api)
            : base(auth, nav)
        {
            _api = api;
            Title = "Notifications";
        ...
        private async Task LoadMoreAsync()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ParentNotificationViewModel] LoadMore error: {ex.Message}");
            }
            finally
            {
                IsLoadingMore = false;
