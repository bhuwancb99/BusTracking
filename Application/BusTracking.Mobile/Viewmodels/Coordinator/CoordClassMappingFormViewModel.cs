...
{
    public partial class CoordClassMappingFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public CoordClassMappingFormViewModel(
            IAuthService auth,
        ...
        public override async Task InitializeAsync()
        {
            await RunAsync(async () =>
            {
                ...
                var subs = await _subjectService.GetAllAsync(null, 1, isCoordinator: true);
        ...
        private async Task SaveAsync()
        {
            ...
            await RunAsync(async () =>
            {
                ...
                var r = await _mappingService.AssignAsync(req, isCoordinator: true);
