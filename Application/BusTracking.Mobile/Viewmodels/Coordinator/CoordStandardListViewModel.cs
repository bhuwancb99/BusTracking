...
{
    public partial class CoordStandardListViewModel : BaseViewModel
    {
        ...
        public CoordStandardListViewModel(IAuthService auth, INavigationService nav, ICoordStandardService standardService)
            : base(auth, nav)
        {
        ...
        [RelayCommand] private Task AddAsync() => Nav.GoToAsync("CoordStandardForm");

        [RelayCommand]
        private Task DetailAsync(StandardItem s) =>
            Nav.GoToAsync("CoordStandardForm", new Dictionary<string, object> { ["StandardId"] = s.StandardId });
