...
{
    public partial class CoordDriverFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public CoordDriverFormViewModel(IAuthService auth, INavigationService nav,
