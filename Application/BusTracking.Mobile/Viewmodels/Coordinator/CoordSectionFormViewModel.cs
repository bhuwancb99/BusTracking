...
{
    public partial class CoordSectionFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public CoordSectionFormViewModel(
            IAuthService auth,
        ...
        public override async Task InitializeAsync()
        {
            await RunAsync(async () =>
            {
                ...
                {
                    var res = await _sectionService.GetByIdAsync(SectionId, isCoordinator: true);
        ...
        private async Task SaveAsync()
        {
            ...
            await RunAsync(async () =>
            {
                if (IsEditMode)
                {
                    ...
                    var r = await _sectionService.UpdateAsync(SectionId, req, isCoordinator: true);
                    if (r.Success)
                    {
                ...
                else
                {
                    ...
                    var r = await _sectionService.CreateAsync(req, isCoordinator: true);
                    if (r.Success)
                    {
