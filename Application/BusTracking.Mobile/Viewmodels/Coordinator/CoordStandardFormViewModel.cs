...
{
    public partial class CoordStandardFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public CoordStandardFormViewModel(IAuthService auth, INavigationService nav, ICoordStandardService standardService)
            : base(auth, nav)
        {
