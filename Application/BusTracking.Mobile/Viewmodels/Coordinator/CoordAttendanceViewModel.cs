    ...
    public partial class CoordAttendanceViewModel : BaseViewModel
    {
        ...
        public override async Task InitializeAsync()
        {
            ...
            try
            {
                ...
                {
                    var secs = await _sectionService.GetByStandardAsync(SelectedStandard.StandardId, isCoordinator: true);
        ...
        private async Task SaveAttendanceAsync()
        {
            ...
            try
            {
                var r = await _attendanceService.SaveManualAttendanceBatchAsync(batch, isCoordinator: true);
                if (r.Success)
        ...
        private async Task StartFaceScanAsync()
        {
            try
            {
                ...
                try
                {
                    var res = await _attendanceService.ProcessFaceScanAttendanceAsync(req, isCoordinator: true);
