...
{
    public partial class CoordFuelLogFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public CoordFuelLogFormViewModel(IAuthService auth, INavigationService nav, IFuelLogService fuelLogService, IBusService busService)
            : base(auth, nav)
        {
