...
{
    public partial class AdminSubjectFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public AdminSubjectFormViewModel(IAuthService auth, INavigationService nav, ISubjectService subjectService)
            : base(auth, nav)
        {
        ...
        public override async Task InitializeAsync()
        {
            if (IsEditMode)
            {
                ...
                {
                    var s = await _subjectService.GetByIdAsync(SubjectId, isCoordinator: false);
                    if (s != null)
                    {
