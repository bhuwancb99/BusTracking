...
{
    public partial class AdminAcademicYearFormViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public AdminAcademicYearFormViewModel(IAuthService auth, INavigationService nav, IAcademicYearService academicYearService)
            : base(auth, nav)
        {
        ...
        private async Task SaveAsync()
        {
            ...
            await RunAsync(async () =>
            {
                ...
                if (IsEditMode)
                {
                    res = await _academicYearService.UpdateAcademicYearAsync(item, isCoordinator: false);
                }
                else
                {
                    res = await _academicYearService.CreateAcademicYearAsync(item, isCoordinator: false);
                }
