...
{
    public partial class AdminSectionListViewModel : BaseViewModel
    {
        ...
        public AdminSectionListViewModel(IAuthService auth, INavigationService nav, ISectionService sectionService, IAdminStandardService standardService)
            : base(auth, nav)
        {
        ...
        private Task AddAsync()
        {
            ...
            return Nav.GoToAsync("AdminSectionForm", new Dictionary<string, object>
            {
        ...
        {
            if (s is null) return;
            var r = await _sectionService.ToggleActiveAsync(s.SectionId, isCoordinator: false);
            if (r.Success)
            {
        ...
        private async Task DeleteAsync(SectionItem s)
        {
            ...
            var r = await _sectionService.DeleteAsync(s.SectionId, isCoordinator: false);
