...
{
    public class RouteController : SuperAdminBaseController
    {
        ...
        public async Task<IActionResult> Index(int page = 1, string? search = null)
        {
            ...
            return View(await _route.GetAllAsync(page, 10, search).Then());
        }
        ...
        public async Task<IActionResult> Create(CreateRouteDto m)
        {
            ...
            var r = await _route.CreateAsync(m, CurrentUserId);
