namespace BusTracking.Web.Areas.BusCoordinator.Controllers
{
    ...
    public class FuelLogController : Controller
    {
        ...
        {
            if (!PermissionHelper.Can(User, "fuellog.view", HttpContext) && !PermissionHelper.Can(User, "fuellog.manage", HttpContext))
                return Forbid();
        ...
        {
            if (!PermissionHelper.Can(User, "fuellog.manage", HttpContext) && !PermissionHelper.Can(User, "fuellog.view", HttpContext))
                return Forbid();
